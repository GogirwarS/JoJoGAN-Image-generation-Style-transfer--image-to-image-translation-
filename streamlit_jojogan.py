...
if torch.cuda.is_available():
    ...
    device = 'cpu'  # Fallback to CPU if CUDA is unavailable
    st.warning('CUDA is not available. Falling back to CPU, which may be slower.')
...
if __name__ == '__main__':
    st.markdown("# ** GAN Image Generation ! **")
